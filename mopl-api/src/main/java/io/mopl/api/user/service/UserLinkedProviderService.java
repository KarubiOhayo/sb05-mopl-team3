...
public class UserLinkedProviderService {
  ...
  /** 소셜 제공자 연동 추가 */
  @Transactional
  public void linkProvider(UUID userId, AuthProvider provider, String providerUserId) {
    User user =
        userRepository
            .findById(userId)
    ...
    UserLinkedProvider link = UserLinkedProvider.create(userId, provider, providerUserId);
